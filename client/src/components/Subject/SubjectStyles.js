...
const Wrapper = styled.section`
  min-height: 800px;
  width: 75%;
  ${media.smallLaptop`width: 90%;`} ${media.bigPhone`width: 100%;`};
`;

const ImageStyle = styled.img`
  width: ${props => props.width}px;
  ${media.smallLaptop`width: 440px;`} ${media.tablet`width: 90%;`}
  marginTop: 20px;
  marginbottom: 20px;
`;
...
export const Code = props => <CodeWrapper>{props.children}</CodeWrapper>;
