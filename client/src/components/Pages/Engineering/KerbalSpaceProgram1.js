  ...
  render() {
    return (
      <Subject title="Kerbal Space Program" urlName="kerbalspaceprogram1">
        {[
          <Body key = "launch" title="Launch a rocket">
          ...
          <Body key = "intoSpace" title="Launch a rocket into space">
          ...
          <Body key = "intoOrbit" title="Orbit">
            ...
            <p>
              3. Check you map with the M button. Once your apoapsis hits
              100,000 meters, cut the engines
            </p>
            <p>
              4. Add a maneuver that casuses your peroapis to be around 100,000
              meters.
            </p>
            <p>5. Select the maneuver autopilot on the left of the navball</p>
            <p>
              6. Once the time until the maneuver is half the time of the actual
              maneuver, turn the throttle all the way up
            </p>
            <p>7. Once you get your desired orbit, cut the engines.</p>
            <p>
              8. To get back down, burn retrograde until your peroapis is in the
              ocean.
            </p>
            <Button badge="one_star" changeScoreValue={10}>
              I made it!
            </Button>
          </Body>,

          <Body key = "spacewalk" title="Spacewalk">
            <Header>Part 1:</Header>
            <p>Make your apoapsis within 1000 meters of each other.</p>
            <Header>Part 2:</Header>
            <p>
              Go on a spacewalk. Get 50 meters away from the spaceship and come
              back
            </p>
            <Button>Done</Button>
          </Body>,

          <Body key = "crash" title="Crash into the moon">
